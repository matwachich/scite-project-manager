...
Func __Lang_LoadDefault()
	...
	__LNG_Add("Menu_NewAssistant",	"New Project Assistant")
	...
	__LNG_Add("Menu_Close",			"Close Actif Project	(Ctrl+Q)")
	...
	__LNG_Add("cfg_OpenAddedFiles",		"Open added file(s)")
	...
	; ---
	; GUI New Project Assistant
	__LNG_Add("NewPrj_WinTitle",		"New Project Assistant")
	__LNG_Add("NewPrj_GuiTitle",		"New Project")
	__LNG_Add("NewPrj_PrjDir",			"Project directory")
	__LNG_Add("NewPrj_Browse",			"Browse")
	__LNG_Add("NewPrj_FolderList",		"Pipe | separated list of folders to create in the project directory")
	__LNG_Add("NewPrj_Files",			"Files")
	__LNG_Add("NewPrj_Add",				"Add")
	__LNG_Add("NewPrj_AddTemplate",		"Add Template")
	__LNG_Add("NewPrj_Remove",			"Remove")
	__LNG_Add("NewPrj_Empty",			"Empty")
	__LNG_Add("NewPrj_Create",			"Create Project")
	; ---
	; Search
	...
	; ---
	; Context Menu
	__LNG_Add("CMenu_Run",			"Run Script")
	...
	__LNG_Add("CMenu_ShellExec",	"Launch In Default Program")
	; ---
	; SciTE
